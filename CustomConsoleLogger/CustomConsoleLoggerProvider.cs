 ...
 * https://github.com/aspnet/Extensions/blob/9bc79b2f25a3724376d7af19617c33749a30ea3a/src/Logging/Logging.Console/src/ConsoleLoggerProvider.cs
 *
...
#pragma warning disable CS0618 // Type or member is obsolete
    ...
    public class CustomConsoleLoggerProvider : ILoggerProvider, ISupportExternalScope
    {
        ...
        private CustomConsoleLogger CreateLoggerImplementation(string name)
        {
            ...
            return new CustomConsoleLogger(name, GetFilter(name, _settings), includeScopes ? _scopeProvider : null, _messageQueue)
            {
